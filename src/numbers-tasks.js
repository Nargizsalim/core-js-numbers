...
function getAverage(value1, value2) {
  ...
  const average = value1 / 2 + value2 / 2 || 0;
...
function getFibonacciNumber(index) {
  if (index < 0) {
    throw new Error('Index should be a non-negative integer.');
  }
...
function numberToStringInBase(number, base) {
  if (Number.isNaN(number) || Number.isNaN(base) || base < 2 || base > 36) {
    // eslint-disable-next-line prettier/prettier
    throw new Error(
      'Invalid input. Number and radix must be valid numbers, and radix must be between 2 and 36.'
    );
  }
...
function toExponential(number, fractionDigits) {
  ...
  if (
    ...
    (Number.isNaN(fractionDigits) || fractionDigits < 0)
  ) {
    throw new Error(
      'Invalid input. fractionDigits must be a non-negative number or undefined.'
    );
  }
...
function toFixed(number, fractionDigits) {
  ...
  if (Number.isNaN(fractionDigits) || fractionDigits < 0) {
    throw new Error(
      'Invalid input. fractionDigits must be a non-negative number.'
    );
  }
...
function toPrecision(number, precision) {
  ...
  if (precision !== undefined && (Number.isNaN(precision) || precision < 1)) {
    throw new Error(
      'Invalid input. precision must be a positive number or undefined.'
    );
  }
...
function getNumberValue(number) {
  ...
  throw new Error(
    'Invalid input. Must be a Number object or a primitive number.'
  );
}
